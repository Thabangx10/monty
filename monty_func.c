...
/**
 * read_file - reading and running the bytecode file
 ...
 * Return: return 1, if string is a num or 0 otherwise
 */
 ...
 * @line: the line to be passed
 * @stack: pointer to the head of the stack
 * @line_number: the current line number
 * Return: return either opcode/NULL/failure
 */
